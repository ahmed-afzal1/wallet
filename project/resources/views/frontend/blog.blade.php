             ...
             @forelse($blogs as $blogg)
                ...
                <div class="blog-box">
                  <div class="blog-images">
                      <div class="img">
                        <img src="{{  $blogg->photo ? asset('assets/images/'.$blogg->photo):asset('assets/images/noimage.png') }}" class="img-fluid" alt="">
                      </div>
            ...
            <div class="recent-post-widget">
              ...
              <ul class="post-list">
                ...
                <li>
                  <div class="post">
                    <div class="post-img">
                      <img style="width: 73px; height: 59px;" src="{{ asset('assets/images/'.$blog->photo) }}" alt="">
                    </div>
