...
@if(Auth::guard('admin')->user()->sectionCheck('Manage Transaction'))
<li class="nav-item">
...
@if(Auth::guard('admin')->user()->sectionCheck('Support Ticket'))
<li class="nav-item">
...
@if(Auth::guard('admin')->user()->sectionCheck('Activities'))
<li class="nav-item">
...
@if(Auth::guard('admin')->user()->sectionCheck('Card Bank Accounts'))
<li class="nav-item">
...
@if(Auth::guard('admin')->user()->sectionCheck('Customer List'))
<li class="nav-item">
