        ...
        @include('includes.admin.form-both')
          ...
          <div class="form-group" id="set-picture">
            ...
            <div class="wrapper-image-preview">
                <div class="box">
                    <div class="back-preview-image" style="background-image: url({{$data->photo ? asset('assets/images/services/'.$data->photo) : asset('assets/images/placeholder.jpg') }});"></div>
          ...
          <div class="form-group">
            <label for="inp-name">{{ __('Subtitle') }}</label>
            <input type="text" class="form-control" id="inp-name" name="subtitle"  placeholder="{{ __('Enter Subtitle') }}" value="{{$data->subtitle}}" required>
        </div>
