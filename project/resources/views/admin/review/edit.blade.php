...
<div class="card">
  ...
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="javascript:;">{{ __('Review') }}</a></li>
  </ol>
  </div>
</div>
...
<div class="col-lg-6">
  ...
  <div class="card mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Review Form') }}</h6>
    </div>
    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{route('admin-review-update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <textarea class="form-control summernote" id="details" name="details" rows="3" placeholder="{{__('Description')}}" required>{{$data->details}}</textarea>
          </div>
