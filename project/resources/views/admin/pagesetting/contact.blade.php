      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="email" value="{{$data->email}}" name="email"  placeholder="{{ __('Email') }}" value="" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="fax" value="{{$data->fax}}" name="fax"  placeholder="{{ __('Fax') }}" value="" required>
          </div>
