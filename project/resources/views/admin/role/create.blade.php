        ...
        <form class="geniusform" action="{{route('admin-role-store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Manage Transaction" class="custom-control-input" id="manage_transaction">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Support Ticket" class="custom-control-input" id="support_ticket">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="Activities" class="custom-control-input" id="activity">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Card Bank Accounts" class="custom-control-input" id="card_bank">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="General Settings" class="custom-control-input" id="general_settings">
                  <label class="custom-control-label" for="general_settings">{{__('General Settings')}}</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Home Page Settings" class="custom-control-input" id="home_page_settings">
                  <label class="custom-control-label" for="home_page_settings">{{__('Home Page Settings')}}</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Menu Page Settings" class="custom-control-input" id="menu_page_setting">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Manage Roles" class="custom-control-input" id="roles">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="Customer List" class="custom-control-input" id="customer_list">
