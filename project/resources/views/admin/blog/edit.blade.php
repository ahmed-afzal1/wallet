    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{route('admin-blog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control mytags" name="tags" placeholder="{{ __('Tags') }}" value="{{$data->tags}}">
          </div>
          ...
          <div class="showbox d-none">
            <div class="form-group">
              ...
              <input type="text" class="form-control mytags" id="meta_tag" name="meta_tag" placeholder="{{ __('Meta Tags') }}">
            </div>
