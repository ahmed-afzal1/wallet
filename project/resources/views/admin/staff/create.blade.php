        ...
        <div class="card-body">
          ...
          <form class="geniusform" action="{{route('admin.staff.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email"  placeholder="{{ __('Enter Email') }}" value="" required>
                <small class="d-block"><span class="badge badge-info">{{__('Note')}}</span> {{__('Email must unique.')}}</small>
              </div>

              <div class="form-group">
                <label for="title">{{ __('Phone') }}</label>
                <input type="text" class="form-control" id="phone" name="phone"  placeholder="{{ __('Enter Phone') }}" value="" required>
              </div>

              <div class="form-group">
                <label for="password">{{ __('Password') }}</label>
                <input type="password" class="form-control" id="password" name="password"  placeholder="{{ __('Enter Password') }}" value="" required>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control"  id="about" name="about" required rows="3" placeholder="{{__('About')}}"></textarea>
              </div>
