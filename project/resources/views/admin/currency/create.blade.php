...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('Dashboard') }}</a></li>
        <li class="breadcrumb-item active" aria-current="page">{{ __('Add New Currency') }}</li>
      </ol>
    </div>
          ...
          <div class="card-body">
            ...
            <form class="geniusform" action="{{route('admin-currency-store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inp-Code" name="code"  placeholder="{{ __('Enter Code') }}" value="" required>
                </div>

                <div class="form-group">
                  <label for="inp-Sign">{{ __('Sign') }}</label>
                  <input type="text" class="form-control" id="inp-Sign" name="sign"  placeholder="{{ __('Enter Sign') }}" value="" required>
                </div>

                <div class="form-group">
                  <label for="inp-Rate">{{ __('Rate') }}</label>
                  <input type="text" class="form-control" id="inp-Rate" name="rate"  placeholder="{{ __('Enter Rate') }}" value="" required>
                </div>
